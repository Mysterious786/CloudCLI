...
CLOUDCLI_JAR="$HOME/.cloudcli/cloudcli.jar"
CLOUDCLI_ENV="$HOME/.cloudcli/.env"

# Auto-load .env - handles special characters properly
...
if [ ! -f "$CLOUDCLI_JAR" ]; then
    ...
    echo "   Please reinstall: curl -fsSL https://raw.githubusercontent.com/Mysterious786/CloudCLI/main/install.sh | bash"
    exit 1
fi
